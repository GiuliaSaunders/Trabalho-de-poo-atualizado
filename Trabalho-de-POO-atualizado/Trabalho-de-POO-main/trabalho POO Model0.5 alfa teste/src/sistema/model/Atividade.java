...
public class Atividade {
	private String nome, horaInicio, horaFim;
	private int data;
	private HashMap<String, Object> listPart;
	private Usuario palestrante;
	private Evento evento;

	public Atividade(String nome, int data, String horaInicio, String horaFim, Evento evento) {
		this.nome = nome;
		this.data = data;
	...
	public int getDataAtv() {
		return data;
	}

	public void setDataAtv(int data) {
		this.data = data;
	}
